...
package com.foundationAS3.ch9 {
    ...
    public class SkinnedList extends Sprite {
        ...
        private function setStyles():void {
            ...
            StyleManager.setComponentStyle(Button, "overSkin", StrokedCircleOver);
            StyleManager.setComponentStyle(Button, "downSkin", StrokedCircleDown);
            StyleManager.setComponentStyle(Button, "disabledSkin", StrokedCircleDisabled);
        }
