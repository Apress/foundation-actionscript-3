package {
    ...
    public class KeyboardDrawing extends Sprite {
        ...
        public function KeyboardDrawing() {
			...
			stage.addEventListener(KeyboardEvent.KEY_DOWN, onCanvasKeyDown);
			stage.addEventListener(KeyboardEvent.KEY_UP, onCanvasKeyUp);
			stage.addEventListener(Event.ENTER_FRAME, onCanvasEnterFrame);
        }
